...
public class NebularCharge : NCNodePopUpOptions
{
    public string header = "One of you must take the charge, who will it be??";
    bool taken = false;
    ...
    void OnButtonClick(bool taken, DebuffStackSO[] augs)
    {
        ...
        if(taken)
        {
            ...
            allPlayersSorted[0].AddDebuffStack(augs[2], 3);
        }
    ...
    IEnumerator TextWait(DebuffStackSO[] augs)
    {
        ...
        yesButton.GetComponentInChildren<TMP_Text>().text = "Take the charge";
        ...
        noButton.GetComponentInChildren<TMP_Text>().text = "No thanks";
    }
}
