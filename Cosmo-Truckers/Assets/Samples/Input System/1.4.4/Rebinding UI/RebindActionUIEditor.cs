...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUIEditor : UnityEditor.Editor
    {
        ...
        {
            // Assign Rebind Action UI as the target 
            rebindActionUI = (RebindActionUI)target;
            ...
            m_OverrideActionProperty = serializedObject.FindProperty("m_OverrideActionLabel"); 
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new EditorGUI.IndentLevelScope())
            {
                EditorGUILayout.PropertyField(m_OverrideActionProperty);

                // Only display string field if override action label is selected true
                if (rebindActionUI.m_OverrideActionLabel)
        ...
        private SerializedProperty m_OverrideActionProperty;
