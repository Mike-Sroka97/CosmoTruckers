...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        [Tooltip("Optional bool field that allows overriding actional label with custom text.")]
        ...
        private void UpdateActionLabel()
        {
            if (m_ActionLabel != null)
            {
                ...
                else
                {
                    ...
                    // Deletes the string so it doesn't remember what we wrote before if we unselected bool
